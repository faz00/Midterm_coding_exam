...
public class ConnectToSqlDB {
    ...
    public void insertDataFromlistToSqlTable(List<String> list, String tableName, String columnName) {
    ...
    public void insertDataFromlistToSqlTable(ArrayList<Integer> list, String tableName, String columnName) {
        try {
            connectToSqlDatabase();
            ps = connect.prepareStatement("DROP TABLE IF EXISTS `" + tableName + "`;");
            ps.executeUpdate();
